import math
from PyQt5.QtWidgets import QDialog, QMessageBox, QGraphicsScene, QGraphicsEllipseItem, QGraphicsLineItem, QGraphicsTextItem, QTableWidgetItem, QAbstractItemView
from PyQt5.QtGui import QPen, QBrush, QColor, QFont, QPainter
from PyQt5.QtCore import Qt
from PyQt5 import uic
from estructuras.no_lineales.Grafo import Graph

class DialogGrafo(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        uic.loadUi("ui/Grafo.ui", self)
    ...
    def configure_graph_interface(self):
        ...
        self.graphicsViewGraph.setRenderHint(QPainter.Antialiasing)
        self.graphicsViewGraph.setAlignment(Qt.AlignCenter)
    ...
    def draw_graph_vertices(self, vertices, vertex_positions, vertex_radius):
    ...
    def draw_empty_graph_message(self, scene_width, scene_height):
        text_item = QGraphicsTextItem("El grafo no contiene vértices.")
        font = QFont()
